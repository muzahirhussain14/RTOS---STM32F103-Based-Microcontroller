...
//#define GPIO_BASE    (*((volatile unsigned long*) 0x40010800))
...
int main(void)
{
	GPIO_Init('D', 1, 0, 2);		//Port D, Input Mode, operation floating input, pin 2
	GPIO_Init('C', 1, 2, 6);		//Port D, Input Mode, operation floating input, pin 6
	GPIO_Init('A', 1, 0, 2);		//Port A, Input Mode, operation floating input, pin 2
